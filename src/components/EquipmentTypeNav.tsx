...
export function EquipmentTypeNav({ customerId }: EquipmentTypeNavProps) {
  ...
  const equipmentTypes = [
    ...
    { icon: Flame, label: "Spot Welder", path: `${basePath}/equipment/spot-welder` },
    { icon: AirVent, label: "Compressor", path: `${basePath}/equipment/compressor` },
    ...
    { icon: Scale, label: "LOLER", path: `${basePath}/equipment/loler` },
  ];
