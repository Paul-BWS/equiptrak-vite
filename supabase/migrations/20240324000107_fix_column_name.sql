-- Drop and recreate service_records with correct column name
DROP TABLE IF EXISTS service_records CASCADE;

CREATE TABLE service_records (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID NOT NULL,  -- Changed from customer_id to company_id
...
-- Grant permissions
GRANT ALL ON service_records TO PUBLIC; 