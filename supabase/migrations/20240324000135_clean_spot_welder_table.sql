-- First, drop everything related to spot welders
DROP TABLE IF EXISTS spot_welder_service_records CASCADE;
DROP INDEX IF EXISTS idx_spot_welder_records_company_id;
DROP INDEX IF EXISTS idx_spot_welder_records_test_date;

-- Create a fresh, simple table
...
CREATE INDEX IF NOT EXISTS idx_spot_welder_company ON spot_welder_service_records(company_id);
CREATE INDEX IF NOT EXISTS idx_spot_welder_test ON spot_welder_service_records(test_date);
