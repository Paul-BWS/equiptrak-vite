...
-- Create a simple spot welder records table with just company_id as foreign key
...
CREATE INDEX idx_spot_welder_company ON spot_welder_service_records(company_id);

-- No RLS, just simple permissions
